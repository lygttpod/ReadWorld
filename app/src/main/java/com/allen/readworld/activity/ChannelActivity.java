...
import com.allen.readworld.adapter.DragAdapter;
import com.allen.readworld.adapter.OtherAdapter;
...
import com.allen.readworld.view.DragGrid;
import com.allen.readworld.view.OtherGridView;
...
public class ChannelActivity extends Activity implements OnItemClickListener {
	...
	private void initData() {
		userChannelList = ((ArrayList<ChannelItem>) ChannelManage.getManage(
				MyAppcaltion.getApp().getSQLHelper()).getUserChannel());
		otherChannelList = ((ArrayList<ChannelItem>) ChannelManage.getManage(
				MyAppcaltion.getApp().getSQLHelper()).getOtherChannel());
